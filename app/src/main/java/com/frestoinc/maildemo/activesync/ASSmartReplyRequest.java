...
public class ASSmartReplyRequest extends ASCommandRequest {
    ...
    public ASSmartReplyRequest() {
        setCommand("SmartReply");
    }
    ...
    @Override
    protected ASMailStatusResponse wrapHttpResponse(Response response) throws Exception {
    ...
    protected void generateXmlPayload() throws Exception {
        ...
        Node sendMailNode = itemOperationsXml.createElementNS(Namespaces.composeMailNamespace,
                Xmlns.composeMailXmlns + ":SmartReply");
        ...
        sendMailNode.appendChild(sourceNode);
